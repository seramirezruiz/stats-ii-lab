...
$$Proportion\,of\,scholaships^{female}_{meth\,use} = \frac{Scholarship^{female}_{meth\,use}}{Total^{female}_{meth\,use}} = \frac{1}{19} = 0.053 $$
And, females who did not do meth: 

$$Proportion\,of\,scholaships^{female}_{no\,meth\,use} = \frac{Scholarship^{female}_{no\,meth\,use}}{Total^{female}_{no\,meth\,use}} = \frac{2}{30} = 0.067 $$

Our NATE for females would be $$NATE_{females} = 0.053 - 0.067 = -0.014$$ or in percentage notation -1.4 percentage points. You can do the same for males  **(R provides a slightly different estimate because we rounded to three decimal points in the previous steps)**
